...
function drawWorld(ctx, world, camera, gravityEnabled) {
    ctx.strokeStyle = renderConfig.floorStrokeColor;
    ctx.lineWidth = renderConfig.wallStrokeWidth;
    ...
    ctx.strokeStyle = renderConfig.wallStrokeColor;
